...
set OWBLD_SAVED_BEGINLIBPATH=%BEGINLIBPATH%
...
set PATH=%OWBOOTSTRAP%\binp;%OWBOOTSTRAP%\binw;%PATH%
set INCLUDE=%OWBOOTSTRAP%\h;%OWBOOTSTRAP%\h\os2
set BEGINLIBPATH=%OWBOOTSTRAP%\binp\dll
...
cd %OWOBJDIR%
if "%OWBOOTSTRAP%" == "" goto mk_ibm
wmake -h -ms -f ..\wmkmake2
goto done_wmk
:mk_ibm
nmake -nologo -f ..\nmkmake
:done_wmk
...
set BEGINLIBPATH=%OWBLD_SAVED_BEGINLIBPATH%
