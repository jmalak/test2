...
// Ugly hack for Microsoft C++ compiler. The 'static' storage-class specifier
// is allowed in the class declaration but not in the definition outside of
// the class. This way we "delete" it from YACC-generated code.
#define static

