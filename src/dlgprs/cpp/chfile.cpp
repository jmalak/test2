...
*  ========================================================================
*
* Description:  The CheckedFile class for the dlgprs tool.
*
****************************************************************************/
...
static std::list<CheckedFile *> OpenFiles;
std::list<CheckedFile *> * CheckedFile::_openFiles = &OpenFiles;
...
// doing a throw in it.
{
    ...
    if( _isOpen ) {
        ...
        if( _openAccess & O_RDONLY ) {
            std::list< CheckedFile * >::iterator it = std::find( _openFiles->begin(), _openFiles->end(), this );
            if( it != _openFiles->end() )
                _openFiles->erase( it );
//            _openFiles->erase( this );
        }
    }
