...
*  ========================================================================
*
* Description:  Core YACC shared internal interfaces.
*
****************************************************************************/
...
struct a_pro {                          /* production: LHS -> RHS1 RHS2 ... */
    ...
    an_item             item[ 1 ];      /* must be the last field */
};
...
void yacc_qsort( void *base, size_t n, size_t size, int (*compar)(const void *, const void *) );
