...
#ifdef __WATCOMC__
            /* The wctomb() function in the Watcom Linux clib does not work
             * correctly. However, the conversion is also not required.
             * At least not on Linux 3.x/4.x kernels (Ubuntu 12.04 to 18.04).
             */
#else
