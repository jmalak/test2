...
# The .prs and .dbg files need special handling
...
#=================
    cdsay <PROJDIR>/ssl
    <BWMAKE> -h
    <CPCMD> <PROJDIR>/dbg/*.dbg         <OWBINDIR>/
    <CPCMD> <PROJDIR>/ssl/*.prs         <OWBINDIR>/

[ BLOCK <1> bootclean ]
#======================
    echo rm -f <OWBINDIR>/*.dbg
    rm -f <OWBINDIR>/*.dbg
    echo rm -f <OWBINDIR>/*.prs
    rm -f <OWBINDIR>/*.prs
...
#   <CCCMD> <PROJDIR>/os2/os2i86.gui/wv.exe   <RELROOT>/binp/wdw16.exe
    ...
    <CCCMD> <PROJDIR>/rdos/rdos386/wv.exe     <RELROOT>/rdos/wd.exe
    <CCCMD> <PROJDIR>/rdos/rdos386/wv.sym     <RELROOT>/rdos/wd.sym
    <CCCMD> <PROJDIR>/dbg/*.dbg               <RELROOT>/rdos/
    <CCCMD> <PROJDIR>/ssl/*.prs               <RELROOT>/rdos/
