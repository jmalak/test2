...
*  ========================================================================
*
* Description:  MCommand class implementation.
*
****************************************************************************/
    ...
    if( target ) {
        ...
        for( int i=0; i<icount; ) {
            ...
            if( strncmp( &com[i], "$@", 2 ) == 0 ) {
                ...
                command.concat( (const char *)*target );
                target->removeQuotes();
