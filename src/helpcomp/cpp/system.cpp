...
*  ========================================================================
*
* Description:  Handle "global" WinHelp file information.
*
****************************************************************************/
      ...
      _rgbMain(main_col), _rgbNonScroll(back_col)
{
    ...
    _position[2] = w;
    _position[3] = h;
    snprintf( _type, HLP_SYS_TYPE, "%s", type );
    snprintf( _name, HLP_SYS_NAME, "%s", name );
    snprintf( _caption, HLP_SYS_CAP, "%s", cap );
}
