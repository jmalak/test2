...
*  ========================================================================
*
* Description:  Analyze type casts.
*
****************************************************************************/
    ...
    ( PTREE expr )              // - cast expression
{
    ...
    switch( ctl.rough ) {
      ...
      case CRUFF_NO_CL :
        ...
        break;
      DbgDefault( "invalid class destination ");
        result = DIAG_IMPOSSIBLE;
    }
    ...
    , PTREE destination )       // - NULL or supplied destination
{
    ...
    switch( ctl.rough ) {
      ...
      case CRUFF_NO_CL :
        ...
        break;
      DbgDefault( "unexpected implicit cast" );
        result = DIAG_IMPOSSIBLE;
    }
    ctl.expr = doCastResult( &ctl, result );
