...
an
/* On macOS Sonoma with clang 17.0.0 there appears to be a compiler
 * bug which calls NotAddrGen with a null pointer despite the null
 * pointer check right above the call.
 * As a workaround, disable optimizations for this function.
 */
