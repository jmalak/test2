...
// The following seemingly redundant define is required for the
// wini86 version of the ui library which needs to link against the
// matching wini86 version of the wres library.
#ifdef __WINDOWS__
